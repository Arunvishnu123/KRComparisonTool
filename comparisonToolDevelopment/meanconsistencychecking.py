...
num_iterations =  10
all_data = [iterate_function_horn_logic(num_iterations),iterate_function_ASP(num_iterations), iterate_function_OWL(num_iterations),iterate_function_Flogic(num_iterations),iterate_function_CLP(num_iterations)]
...
ax.set_xticklabels(['Horn Logic', 'ASP', "OWL","F-Logic", "CLP"])

# Set labels and title
ax.set_ylabel('Time Delay')
ax.set_title('Consistency Checking - Response time mean for 100 iterations')
